...
import sys
#Check which version of Tkinter you have and use proper import command
...
maxLeak=.0003#The leak conductance (uS)
...
#The cell class...builds a default cell that may be modified by user input
class cell(object):
